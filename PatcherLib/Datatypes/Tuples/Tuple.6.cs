...
namespace Lokad
{
    ...
    public sealed class Tuple<T1, T2, T3, T4, T5, T6> : IEquatable<Tuple<T1, T2, T3, T4, T5, T6>>
    {
        ...
        /// <summary>
        /// Returns a <see cref="T:System.String"/> that represents the current <see cref="Tuple{T1,T2,T3,T4,T5,T6}"/>.
        /// </summary>
        /// <returns>
        /// A <see cref="T:System.String"/> that represents the current <see cref="Tuple{T1,T2,T3,T4,T5,T6}"/>.
        /// </returns>
        ...
        /// <summary>
        /// Determines whether the specified <see cref="T:System.Object"/> is equal to the current <see cref="Tuple{T1,T2,T3,T4,T5,T6}"/>.
        /// </summary>
        /// <param name="obj">The <see cref="T:System.Object"/> to compare with the current <see cref="Tuple{T1,T2,T3,T4,T5,T6}"/>.</param>
        /// <returns>
        /// true if the specified <see cref="T:System.Object"/> is equal to the current <see cref="Tuple{T1,T2,T3,T4,T5,T6}"/>; otherwise, false.
        /// </returns>
        ...
        public override bool Equals( object obj )
        {
            ...
            if (obj.GetType() != typeof( Tuple<T1, T2, T3, T4, T5, T6> )) return false;
        ...
        /// </param>
        public bool Equals( Tuple<T1, T2, T3, T4, T5, T6> obj )
        {
        ...
        /// </summary>
        /// <returns>
        /// A hash code for the current <see cref="Tuple{T1,T2,T3,T4,T5, T6}" />.
        /// </returns>
        /// <filterpriority>2</filterpriority>
        public override int GetHashCode()
        {
            return SystemUtil.GetHashCode( Item1, Item2, Item3, Item4, Item5, Item6 );
        }
