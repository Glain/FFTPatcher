	...
	public class ASMRegisterHelper
	{
        ...
        public static int GetEncodingBitLength(char elementTypeChar)
        {
            switch (elementTypeChar)
            {
                ...
                default: return EncodingBitLengths.GPRegister;
            }
        }
        ...
        public static string GetRegisterPrefix(char elementTypeChar)
        {
            switch (elementTypeChar)
            {
                ...
                default: return Prefixes.GPRegister;
            }
        }

        public static bool IsVFPURegister(char elementTypeChar)
        {
            return ((elementTypeChar == ASMElementTypeCharacter.VFPURegister) || (elementTypeChar == ASMElementTypeCharacter.PartialVFPURegister) || (elementTypeChar == ASMElementTypeCharacter.InvertedSingleBitVFPURegister));
        }
		...
		{
			StreamReader reader = new StreamReader(ASMDataFileMap.MIPS_GPRegisters);
			...
			try
			{
				...
				while (reader.Peek() != -1)
				{
                    ...
                    {
                        GPRegisterList.Add(line);
                        GPRegisterIndexDict.Add(line, regIndex);
                    }
