...
namespace ASMEncoding.Helpers
{
    public static class ASMDataFileMap
    {
        ...
        public static string PSX_GTEControlRegisters = "ASMEncodingData/psx_gte_control_regs.dat";
        public static string PSX_GTEDataRegisters = "ASMEncodingData/psx_gte_data_regs.dat";
        public static string PSP_Encoding = "ASMEncodingData/psp_encode.dat";
        public static string PSP_VFPURegisters = "ASMEncodingData/psp_vfpu_regs.dat";
    }
}
