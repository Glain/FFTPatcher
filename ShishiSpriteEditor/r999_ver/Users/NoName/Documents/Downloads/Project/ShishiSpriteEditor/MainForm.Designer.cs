...
namespace FFTPatcher.SpriteEditor
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            importSprMenuItem.Text = "Reimport BMP"; // R999
			...
			//
			// reimportMenuItem R999
			reimportMenuItem.Index = 5;
            reimportMenuItem.Text = "Reimport BMP";
			reimportMenuItem.Click += new System.EventHandler( this.reimportMenuItem_Click);

			// reimport Button R999
