  ...
  <xsl:template match="/digest/AllStatusAttributes">
    ...
    <xsl:for-each select="StatusAttribute">
      ...
      <table class="differencesTable">
        ...
        <xsl:for-each select="Blank1|Blank2|Order|CT|FreezeCT|Unknown1|Unknown2|Unknown3|Unknown4|Unknown5|Unknown6|CountsAsKO|CanReact|Blank|IgnoreAttacks|Unknown7|Unknown8|Unknown9|CancelledByImmortal|LowerTargetPriority">
          <tr>
            <td>
              <xsl:value-of select="name(.)"/>
            </td>
